export default {
  dialogs: {
    ...
    restoreTitle: '重置为原厂音色？',
    restoreIntro: '这将替换全部四个本地音色库。重置后可立即撤销。',
    restoreClose: '关闭原厂重置',
  ...
  controlHelp: {
    ...
    effectPresets:
      '将此效果的控制设为一个起点。先打开该效果才能选择预设。其他效果保持不变，撤销可恢复之前的设置。',
    oscillatorSync:
  ...
  banks: {
    ...
    importFailed: '导入失败。',
    restoreFailed: '无法将音色库重置为原厂音色。请重试。',
    ...
    everywhere: {
      ...
      savedBanks: '已保存的音色库',
      catalog: '其他 DX7 音色库',
      play: '试听 {{origin}} 中的 {{name}}',
      playTitle: '单击通过 FM1 编辑缓冲区试听 {{name}}；双击复制并编辑',
      copy: '将 {{name}} 复制到工作区音色库',
      truncated: '显示 {{total}} 个结果中的前 {{shown}} 个。输入更多内容以缩小搜索范围。',
  ...
  namedBanks: {
    ...
    update: '更新信息',
    savedBanks: '已保存的音色库',
    count: '已保存 {{count, number}} 个音色库',
    count_other: '已保存 {{count, number}} 个音色库',
    search: '搜索已保存的音色库',
    loading: '正在加载已保存的音色库…',
  ...
  backup: {
    menuSysex: '用于其他 DX7 工具',
    sysexContents: '仅含 DX7 数据，不含 FM1 效果',
    menuHeading: '完整备份',
    download: '下载备份',
    restore: '从备份恢复…',
    backupContents: '含 FM1 效果',
    lastBackup: '上次备份：{{date}}',
    downloaded: '正在下载工作区音色库和已保存音色库的备份。',
    downloadedWithoutSavedBanks:
      '正在下载工作区音色库的备份。无法读取已保存的音色库，因此备份中不包含它们。',
    downloadedWithoutDamaged: '正在下载备份。部分已保存的音色库无法读取，因此备份中不包含它们。',
    unavailable: '无法打开备份功能。请重新加载页面后重试。',
    unavailableUnsaved: '无法生成备份。请保持此标签页打开，因为最近的更改尚未保存，然后重试。',
    restoreTitle: '从备份恢复',
    restoreIntro: '请选择用“下载备份”生成的文件。确认之前不会有任何更改。',
    chooseFile: '选择备份文件',
    reading: '正在读取备份…',
    backedUpAt: '备份时间',
    workspaceBanks: '工作区音色库',
    patches: '音色',
    savedBanks: '已保存的音色库',
    toAdd: '将添加',
    alreadyHere: '已存在，保留',
    unreadable: '无法读取',
    workspaceEffect: '工作区音色库及其全部音色将被备份中的内容替换。之后可在通知中点击撤销来恢复。',
    savedBanksEffect:
      '已保存的音色库只会被添加。此浏览器中已有的会保持不变，撤销也不会移除已添加的音色库。',
    restoreAction: '恢复备份',
    restoring: '正在恢复…',
    restored: '已恢复 {{date}} 的备份。',
    errors: {
      format: '此文件不是本应用的备份。请选择用“下载备份”生成的 .json 文件。',
      newer: '此备份由本应用的较新版本生成。请重新加载页面以更新应用，然后重试。',
      damaged: '此备份已损坏，无法恢复。请尝试其他备份文件。',
