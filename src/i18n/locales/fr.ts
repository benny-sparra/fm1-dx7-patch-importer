export default {
  ...
  ui: {
    ...
    sequencerOpenFailed: 'Impossible d’ouvrir le séquenceur. Rechargez la page et réessayez.',
  ...
  common: {
    ...
    loadingSequencer: 'Chargement du séquenceur…',
  ...
  midi: {
    ...
    chooseInput: 'Choisissez une entrée MIDI',
