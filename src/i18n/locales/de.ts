export default {
  ...
  ui: {
    ...
    sequencer: 'Sequencer',
    sequencerOpenFailed:
      'Der Sequencer konnte nicht geöffnet werden. Lade die Seite neu und versuche es erneut.',
  ...
  common: {
    ...
    loadingSequencer: 'Sequencer wird geladen…',
  ...
  midi: {
    ...
    chooseInput: 'MIDI-Eingang wählen',
