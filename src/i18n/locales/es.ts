export default {
  ...
  ui: {
    ...
    sequencerOpenFailed:
      'No se pudo abrir el secuenciador. Recarga la página e inténtalo de nuevo.',
  ...
  common: {
    ...
    loadingSequencer: 'Cargando el secuenciador…',
  ...
  root: {
    ...
    unsupportedBody:
      'Este bibliotecario necesita un navegador de escritorio compatible con Web MIDI y SysEx, como Chrome, Edge, Firefox u Opera. Los teléfonos y las tabletas no son compatibles.',
  ...
  editor: {
    ...
    effectPresetOptions: {
      ...
      thin: 'Fino',
      resonant: 'Resonante',
      lightDrive: 'Saturación ligera',
      warmDrive: 'Saturación cálida',
      crunch: 'Crujiente',
      fuzz: 'Fuzz',
      smallRoom: 'Sala pequeña',
      largeRoom: 'Sala grande',
      smallHall: 'Salón pequeño',
      largeHall: 'Gran salón',
      plate: 'Placa',
      slapback: 'Slapback',
      quickDelay: 'Retardo corto',
      quickRepeats: 'Repeticiones rápidas',
      echo: 'Eco',
      subtleChorus: 'Coro sutil',
      ensemble: 'Conjunto',
      chorusWash: 'Coro envolvente',
      shimmer: 'Brillo',
      gentlePhase: 'Fáser suave',
  ...
  midi: {
    ...
    chooseInput: 'Elige una entrada MIDI',
    ...
    errors: {
      ...
      unsupportedBrowser:
        'Este navegador no es compatible con Web MIDI. Usa un navegador de escritorio, como Chrome, Edge o Firefox.',
      permissionDenied:
        'Se bloqueó el acceso MIDI. Permite el acceso MIDI y SysEx para este sitio y vuelve a conectar. En Firefox, acepta el complemento de permisos del sitio cuando se ofrezca.',
      enableFailed:
