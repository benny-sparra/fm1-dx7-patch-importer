import { dialogResources } from './dialog-resources'
import { bankSourceResources } from './bank-source-resources'
  ...
  en: {
    translation: {
      ...
      banks: {
        ...
        soundDataHelp:
          'Every new workspace bank starts with a complete standard 32-voice DX7 bank.',
      ...
      namedBanks: namedBankResources.en,
    },
  },
  fr: {
    translation: {
      ...
      editor: {
        ...
        presetOptions: {
          ...
          'gentle-motion': {
            name: 'Mouvement doux',
            description:
              'Un LFO sinusoïdal retardé, un léger chorus et une douce ambiance de hall.',
          },
          'warm-filter': {
      ...
      banks: {
        ...
        soundDataHelp:
          'Chaque nouvelle banque contient une banque DX7 standard complète de 32 voix.',
      ...
      namedBanks: namedBankResources.fr,
    },
  },
  es: {
    translation: {
      ...
      namedBanks: namedBankResources.es,
    },
  },
  de: {
    translation: {
      ...
      editor: {
        ...
        presetOptions: {
          ...
          'gentle-motion': {
            ...
            description:
              'Ein verzögerter Sinus-LFO, leichter Chorus und eine weiche Hall-Atmosphäre.',
          },
          'warm-filter': {
            name: 'Warmer Filter',
      ...
      banks: {
        ...
        bankInformationHelp:
          'Bearbeite den Titel und die optionale Beschreibung dieser Arbeitsbank.',
      ...
      namedBanks: namedBankResources.de,
    },
  },
  'pt-BR': {
    translation: {
      ...dialogResources.ptBR,
      ...helpResources.ptBR,
      ...uiResources.ptBR,
      ...
      namedBanks: namedBankResources.ptBR,
    },
  },
  'zh-Hans': {
    translation: {
      ...dialogResources.zhHans,
      ...
      help: {
        ...
        steps: {
          ...
          transferTitle: '传输音色',
          transferBody:
            '在对应的 FM1 音色槽中试听单个音色，或传输完整音色库并在合成器上选择目标位置。',
        },
      },
      colorway: {
        finish: 'FM1 外观',
      ...
      editor: {
        ...
        presetOptions: {
          'soft-pad': { name: '柔和铺底', description: '缓慢的包络、柔和的合唱与轻柔的大厅混响。' },
          'bright-pluck': {
            name: '明亮拨弦',
          ...
          'wide-space': { name: '宽阔空间', description: '合唱与大厅混响营造宽广的氛围层次。' },
        },
        undo: '撤销',
        redo: '重做',
        save: '保存到音色库',
      ...
      namedBanks: namedBankResources.zhHans,
    },
  },
} as const
