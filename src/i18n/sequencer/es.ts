export default {
  ...
  grid: {
    ...
    pitchColumn: 'Altura',
    cell: 'Paso {{step}}, {{note}}',
    stepPlays: 'El paso {{step}} toca {{note}}',
    stepRests: 'El paso {{step}} es un silencio',
    octaveUp: 'Mostrar la octava superior',
    octaveDown: 'Mostrar la octava inferior',
    velocityLane: 'Velocidad',
    velocityFor: 'Velocidad del paso {{step}}',
    velocityValue: 'Paso {{step}}: velocidad {{velocity}}',
  },
  listen: {
