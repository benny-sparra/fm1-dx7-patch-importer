export default {
  ...
  grid: {
    ...
    pitchColumn: 'Pitch',
    cell: 'Step {{step}}, {{note}}',
    stepPlays: 'Step {{step}} plays {{note}}',
    stepRests: 'Step {{step}} is a rest',
    octaveUp: 'Show the octave above',
    octaveDown: 'Show the octave below',
    velocityLane: 'Velocity',
    velocityFor: 'Velocity for step {{step}}',
    velocityValue: 'Step {{step}}: velocity {{velocity}}',
  },
  listen: {
