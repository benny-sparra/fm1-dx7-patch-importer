export default {
  ...
  grid: {
    heading: 'Schritte',
    pitchColumn: 'Tonhöhe',
    cell: 'Schritt {{step}}, {{note}}',
    stepPlays: 'Schritt {{step}} spielt {{note}}',
    stepRests: 'Schritt {{step}} ist eine Pause',
    octaveUp: 'Die Oktave darüber anzeigen',
    octaveDown: 'Die Oktave darunter anzeigen',
    velocityLane: 'Anschlag',
    velocityFor: 'Anschlag für Schritt {{step}}',
    velocityValue: 'Schritt {{step}}: Anschlag {{velocity}}',
  },
  listen: {
    heading: 'FM1 abhören',
    start: 'FM1 abhören',
