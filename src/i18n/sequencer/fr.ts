export default {
  ...
  grid: {
    ...
    pitchColumn: 'Hauteur',
    cell: 'Pas {{step}}, {{note}}',
    stepPlays: 'Le pas {{step}} joue {{note}}',
    stepRests: 'Le pas {{step}} est un silence',
    octaveUp: 'Afficher l’octave supérieure',
    octaveDown: 'Afficher l’octave inférieure',
    velocityLane: 'Vélocité',
    velocityFor: 'Vélocité du pas {{step}}',
    velocityValue: 'Pas {{step}} : vélocité {{velocity}}',
  },
  listen: {
