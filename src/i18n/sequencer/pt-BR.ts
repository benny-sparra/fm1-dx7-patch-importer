export default {
  ...
  grid: {
    heading: 'Passos',
    pitchColumn: 'Altura',
    cell: 'Passo {{step}}, {{note}}',
    stepPlays: 'O passo {{step}} toca {{note}}',
    stepRests: 'O passo {{step}} é uma pausa',
    octaveUp: 'Mostrar a oitava acima',
    octaveDown: 'Mostrar a oitava abaixo',
    velocityLane: 'Velocidade',
    velocityFor: 'Velocidade do passo {{step}}',
    velocityValue: 'Passo {{step}}: velocidade {{velocity}}',
  },
  listen: {
    heading: 'Ouvir o FM1',
    start: 'Ouvir o FM1',
