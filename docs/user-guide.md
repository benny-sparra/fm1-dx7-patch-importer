...
The Reverb and Delay boxes on the effects panel each have a **Preset** menu: **Small room**, **Large room**, **Small hall**, **Large hall**, and **Plate** for reverb, and **Slapback**, **Quick delay**, **Quick repeats**, and **Echo** for delay. Switch the effect on to choose a preset; it sets that effect's controls and leaves the other effects as they are. It sends that effect to the FM1 and is a single undo step.
