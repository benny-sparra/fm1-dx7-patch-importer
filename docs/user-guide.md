...
The Reverb, Delay, Chorus, and Phaser boxes on the effects panel each have a **Preset** menu: **Small room**, **Large room**, **Small hall**, **Large hall**, and **Plate** for reverb, **Slapback**, **Quick delay**, **Quick repeats**, and **Echo** for delay, **Subtle chorus**, **Ensemble**, **Chorus wash**, and **Shimmer** for chorus, and **Gentle phase**, **Slow sweep**, **Deep phase**, and **Fast swirl** for phaser. Switch the effect on to choose a preset; it sets that effect's controls and leaves the other effects as they are. It sends that effect to the FM1 and is a single undo step.
